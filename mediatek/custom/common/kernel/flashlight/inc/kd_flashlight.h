...
//zhfan FL sys pr458716
#define FLASHLIGHT_TORCH_ENG _IOWR(FLASHLIGHT_MAGIC,50,unsigned long)
#define FLASHLIGHT_FLASHLIGHT_ENG _IOWR(FLASHLIGHT_MAGIC,51,unsigned long)
