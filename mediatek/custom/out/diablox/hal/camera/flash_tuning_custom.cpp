...
//[begin]467220 zhfan 2013-6-10 change the duty number from 17 to 32 for more accurate samrt flashlight
FLASH_PROJECT_PARA& cust_getFlashProjectPara(int aeMode, NVRAM_CAMERA_STROBE_STRUCT* nvrame)
{
	...
	para.engLevel.pfDutyL = 7;
	para.engLevel.mfDutyMaxL = 25;
	para.engLevel.mfDutyMinL = 0;
	para.engLevel.pmfStepL = 0;

	//burst setting
	para.engLevel.IChangeByBurstEn=1;
	para.engLevel.pfDutyB = 7;
	para.engLevel.mfDutyMaxB = 9;
	...
	para.coolTimeOutPara.tabId[2]=13;
	para.coolTimeOutPara.tabId[3]=18;
	para.coolTimeOutPara.tabId[4]=23;
	para.coolTimeOutPara.tabId[5]=28;
