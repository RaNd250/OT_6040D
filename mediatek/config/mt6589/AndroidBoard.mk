...
##### add by ydyu for CPU temperature ontrol BL ############
#PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/configs/6589dtm_jrd_bl_trim.mtc:data/.6589dtm_jrd_bl_trim.mtc
...
_scribe_pro_compass_cfg := $(MTK_ROOT_CONFIG_OUT)/configs/accel_nvm
ifeq ("scribepro","$(TARGET_PRODUCT)")
ifneq ($(wildcard $(_scribe_pro_compass_cfg)),)
PRODUCT_COPY_FILES += $(_scribe_pro_compass_cfg):system/etc/accel_nvm
endif
endif
