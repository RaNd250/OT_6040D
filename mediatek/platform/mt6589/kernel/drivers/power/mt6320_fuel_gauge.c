...
{
    #if defined(DIABLOPHA_FUEL_GUAGE)
...
{    
    ...
    if (byd_sucd_batt_id == 1)
    {
    	gFG_BATT_CAPACITY_init_high_current = BYD_Q_MAX_POS_25_H_CURRENT;    
    	gFG_BATT_CAPACITY_aging = BYD_Q_MAX_POS_25;
    }
    else
    {
	gFG_BATT_CAPACITY_init_high_current = SCUD_Q_MAX_POS_25_H_CURRENT;    
    	gFG_BATT_CAPACITY_aging = SCUD_Q_MAX_POS_25;
    }
  #endif
