...
static int yamaha_probe(struct platform_device *pdev) 
{
	...
	/*hard reset akm8963 chip*/
	mt_set_gpio_mode(YAMAHA533_RST, GPIO_MODE_00);
	mt_set_gpio_dir(YAMAHA533_RST, GPIO_DIR_OUT);
	mt_set_gpio_out(YAMAHA533_RST, GPIO_OUT_ZERO);
	udelay(10);
	mt_set_gpio_out(YAMAHA533_RST, GPIO_OUT_ONE);
